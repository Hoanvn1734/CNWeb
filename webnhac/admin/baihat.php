                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><a href="insert.php?name=baihat">Thêm bài hát</a></div>
                            ...
                            <div class="panel-body">
                                <table class="table" border="1" bordercolor="gray" width="880">
                                    ...
                                    <th><center>Ca sĩ thể hiện</center></th>
                                    <th><center>Chủ đề</center></th>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <th>
                                            <center>
                                                <a href="update.php?baihat_id=<?php echo $row['baihat_id']; ?>">Sửa</a>&nbsp; | &nbsp
                                                <a href="remove.php?baihat_id=<?php echo $row['baihat_id']; ?>">Xóa</a>
                                            </center>
                                            </th>
                                            </tr>
                                            <?php
                                ...
                                <div class="pagination">
                                    ...
                                    for ($i = 1; $i <= $total_page; $i++) {
                                        ...
                                        if ($i == $current_page) {
                                            ...
                                            echo '<a href="baihat.php?name=baihat&&page=' . $i . '">' . $i . '</a> | ';
                                        }
                                    }
