    ...
    <html>
        ...
        <body>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">User - Bài hát</h1>
                    </div>
                </div><!--/.row-->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table class="table" border="1" bordercolor="gray" width="880">
                                    ...
                                    <?php
                                    $sql = "SELECT user_id, song_id, tenbaihat FROM user_song, baihat WHERE baihat_id = song_id";
                                    $result = mysqli_query($conn, $sql);
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <tr>
                                                <th><center><?php echo $row['user_id']; ?></center></th>
                                            <th><center><?php echo $row['song_id']; ?></center></th>
