    ...
    s.prototype = {
        init: function () {
            ...
            return this.playlistSrc = this.getPlaylist(),
                    this.playlist ? (this.playlist = this.playlistSrc.slice(0),
                            this.listLen = this.playlist.length,
                            this.shuffBut.attr("data-state", this.opts.shuffled).toggleClass(function () {
                        return e.getShuffleStatus() ? "shuffleActive" : "shuffle"
                    }),
                            this._player = t("<audio />").data("audIndex", parseInt(document.forms['fake-form'].elements[0].value)),
            ...
            this.opts.autoPlay && this._player.attr("autoplay", !0),
                    ...
                    this._audio.volume = this.volumeRange.val()
                    || this.opts.audioVolume,
                    this.shuffleState(),
                    this.source(),
                    0 == t("audio").length
                    && t("body").append(this._player),
                    this.getIndex() <= 0 && (
                    this.buttonPrevious = !1,
                    this.prevBut.addClass("disabled")),
                    this.attachEvents()
...
//                    a = Math.floor(Math.random() * i), i -= 1, e = t[i], t[i] = t[a], t[a] = e;
            ...
            this._player.attr({src: n, type: this.getDataType(this.playlist[e])}), this._player.data("audIndex", e), this._player.html(s), this.onSongChange(e), a != i && 1 == a && this.play()
        }, onSongChange: function (t) {
            var e = this.updateActiveSong(t);
            this.updatePrevNextButtons();
            {
                var a = {index: e, title: this.playListObj.eq(e).find("a").text(), ele: this.playListObj.eq(e)};
            ...
            this.getIndex() > 0 ? (
                    this.buttonPrevious = !0,
                    this.prevBut.removeClass("disabled")) :
                    (
                            this.buttonPrevious = !1,
                            this.prevBut.addClass("disabled")),
                    this.getIndex() < this.listLen - 1 ?
                    (this.buttonNext = !0,
                            this.nextBut.removeClass("disabled")) : (this.buttonNext = !1, this.nextBut.addClass("disabled"))
            ...
            this.shuffBut.on("click", function () {
                ...
                if (nextIndex = e.getIndex() + 1, e.seekTrack.css("width", "0%"), e.listLen != nextIndex)
                    e.source(nextIndex, !0);
                else {
                    if (!e.opts.loopPlaylist)
                        return!1;
